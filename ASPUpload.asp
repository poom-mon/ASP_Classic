...
Class ASPUpload
	...
	Public Sub CreateDir(path, dir)
		Set fs = Server.createObject("Scripting.FileSystemObject")
		If fs.FolderExists(path & "/" & dir) = false Then
			fs.createfolder(path & "/" & dir)
		end if
		set fs = nothing
	End Sub
	
	'Saves the uploaded files
	Public Sub Save(path, id)
		...
		For Each fileItem In UploadedFiles.Items
			...
			streamFile.SaveToFile path & "/" & id & "/" & fileItem.FileName, 2
			streamFile.close
